          ...
          <>
            {dog.sex === 'FEMALE' && (
              <Button variant="outline" size="sm" asChild>
                <Link href={`/studio/dogs/${slug}/heats`}>
                  <CalendarHeart /> Heats
                </Link>
              </Button>
            )}
            <Button variant="outline" size="sm" asChild>
              <Link href={`/studio/dogs/${slug}/pedigree`}>
                <GitBranch /> Pedigree
              </Link>
            </Button>
      ...
      >
        {dog.supersededBy && (
          <Alert tone="warning" className="mb-4">
            ...
            <Link href={`/studio/dogs/${dog.supersededBy.slug}`} className="font-semibold underline">
