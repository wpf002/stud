    ...
    <StudioShell kennelName="Blackwater Kennels" userName="Jordan Hale">
        ...
        actions={
          <>
            <Button variant="outline" size="sm" asChild>
              <Link href="/pedigrees/duplicates">
      ...
      >
        <div className="mb-4 grid gap-4 sm:grid-cols-2">
          <Card interactive>
            <Link href="/pedigrees/pairing" className="block p-5">
          ...
          <Card interactive>
            <Link href="/pedigrees/duplicates" className="block p-5">
                  ...
                  <li key={im.id} className="flex items-center justify-between gap-4 py-3">
                    <div className="min-w-0">
                      <p className="truncate text-sm font-medium text-ink-800">
                        {im.rootDog ? (
                          <Link href={`/dogs/${im.rootDog.slug}`} className="hover:text-brand-700">
                            {im.rootDog.callName}
                          </Link>
                        ) : (
